    ...
    <section class="dashboard">
        <div class="dashboard_sidebar">
            ...
            <a class="dashboard_sidebar_logo" href="index.html">
                <img src="assets/images/logo_1.png" alt="MaxLand " class="img-fluid w-100">
            </a>
            <div class="dashboard_sidebar_user">
                <div class="img">
                    <img src="assets/images/agent_8.jpg" alt="dashboard" class="img-fluid w-100">
                ...
                <ul>
                    <li>
                        <a class="active" href="dashboard.html">
                            <span>
                                <img src="assets/images/dashboard_icon_1.png" alt="icon" class="img-fluid w-100">
                            </span>
                            dashboard
                        </a>
                    </li>
                    <li>
                        <a href="dashboard_profile.html">
                            <span>
                                <img src="assets/images/dashboard_icon_2.png" alt="icon" class="img-fluid w-100">
                            </span>
                            Profile
                        </a>
                    </li>
                    <li>
                        <a href="dashboard_property.html">
                            <span>
                                <img src="assets/images/dashboard_icon_3.png" alt="icon" class="img-fluid w-100">
                            </span>
                            Property
                        </a>
                    </li>
                    <li>
                        <a href="dashboard_pricing.html">
                            <span>
                                <img src="assets/images/dashboard_icon_4.png" alt="icon" class="img-fluid w-100">
                            </span>
                            Pricing Plan
                        </a>
                    </li>
                    <li>
                        <a href="dashboard_order.html">
                            <span>
                                <img src="assets/images/dashboard_icon_7.png" alt="icon" class="img-fluid w-100">
                            </span>
                            order
                        </a>
                    </li>
                    <li>
                        <a href="dashboard_wishlist.html">
                            <span>
                                <img src="assets/images/dashboard_icon_6.png" alt="icon" class="img-fluid w-100">
                            </span>
                            Wishlist
                        </a>
                    </li>
                    <li>
                        <a href="dashboard_review.html">
                            <span>
                                <img src="assets/images/dashboard_icon_5.png" alt="icon" class="img-fluid w-100">
                            </span>
                            Reviews
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <span>
                                <img src="assets/images/dashboard_icon_8.png" alt="icon" class="img-fluid w-100">
                            </span>
                            Logout
                        </a>
                    </li>
                ...
                <div class="row">
                    <div class="col-xxl-3 col-md-6 col-xl-6 wow fadeInUp" data-wow-duration="1.5s">
                        <div class="dashboard_overview_item">
                            ...
                            <h3> 471 <span>Listing Property</span></h3>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-md-6 col-xl-6 wow fadeInUp" data-wow-duration="1.5s">
                        <div class="dashboard_overview_item blue">
                            ...
                            <h3> 56 <span>Pending Property</span></h3>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-md-6 col-xl-6 wow fadeInUp" data-wow-duration="1.5s">
                            ...
                            <div class="table-responsive wow fadeInUp" data-wow-duration="1.5s">
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="images">
                                                <img src="assets/images/property_1.jpg" alt="property"
                                        ...
                                        <tr>
                                            <td class="images">
                                                <img src="assets/images/property_2.jpg" alt="property"
                                                    class="img-fluid w-100">
                                            </td>
                                            <td class="details">
                                                <a class="item_title" href="property_details.html">Hermosa Casa al
                                                    Norte</a>
                                                <p>Posting date: March 22, 2024</p>
                                            </td>
                                            <td class="price">
                                        ...
                                        <tr>
                                            <td class="images">
                                                <img src="assets/images/property_3.jpg" alt="property"
                                                    class="img-fluid w-100">
                                            </td>
                                            <td class="details">
                                                <a class="item_title" href="property_details.html">South Side Garden
                                                    House</a>
                                                <p>Posting date: March 22, 2024</p>
                                            </td>
                                            <td class="price">
                                        ...
                                        <tr>
                                            <td class="images">
                                                <img src="assets/images/property_4.jpg" alt="property"
                                                    class="img-fluid w-100">
                                            </td>
                                            <td class="details">
                                                <a class="item_title" href="property_details.html">Leisure Beautiful
                                        ...
                                        <tr>
                                            <td class="images">
                                                <img src="assets/images/property_5.jpg" alt="property"
                                                    class="img-fluid w-100">
                                            </td>
                                            <td class="details">
                                                <a class="item_title" href="property_details.html">Hermosa Casa al
