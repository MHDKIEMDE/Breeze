    ...
    <nav class="navbar navbar-expand-lg main_menu">
        <div class="container container_large">
            <a class="navbar-brand" href="index.html">
                <img src="assets/images/logo_2.png" alt="MaxLand" class="img-fluid">
            </a>
                    ...
                    @if (Route::has('login'))
                        <nav class="-mx-3 flex flex-1 justify-end">
                            <ul class="menu_right d-flex align-items-center">
                                @auth
                                    <li>
                                        <a class="user_icon" href="{{ route('dashboard') }}">
                                            <span>
                                ...
                                @endauth
                                <li>
                                    <div class="toggol_bar" data-bs-toggle="offcanvas"
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-xl-5 col-lg-6 wow fadeInRight" data-wow-duration="1.5s">
                    <div class="about_text">
                        ...
                        <a href="about_us.html" class="common_btn">More Details</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="destination_area pt_115 xs_pt_110 pb_110 xs_pb_90">
        <div class="container">
            ...
            <div class="row destination_slider">
                ...
                <div class="col-xl-3 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="single_destination">
                        <img src="assets/images/destination_6.jpg" alt="img" class="img-fluid w-100">
                        <div class="destination_address">
                            <a href="property_grid_view.html"><i class="far fa-arrow-right"></i></a>
                            <div class="destination_text">
                                <h5>New York</h5>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="copyright_area d-flex flex-wrap justify-content-between">
                            <p>© 2024 MaxLand All Rights Reserved</p>
                            <ul class="d-flex flex-wrap">
                                <li><a href="privacy_policy.html">Privacy Policy </a></li>
